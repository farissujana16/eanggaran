...
class Model_user extends CI_Model
{
    ...
    public function update_token($id, $token, $refresh)
    {
        ...
        return $this->db->update('sso.ref_user', $data);
    }
    ...
    {
        $this->db->insert('sso.ref_user', $data);
    }
    ...
    public function getAllUser($show = null, $start = null, $cari = null)
    {
        ...
        $this->db->join('sso.ref_bu f', 'a.id_bu = f.id_bu', 'left');
        $session = $this->session->userdata('login');
    ...
    public function UpdateUser($id_user, $data)
    {
        ...
        $this->db->where('id_perusahaan', $session['id_perusahaan']);
        $this->db->where('id_user', $id_user);
        $this->db->update('sso.ref_user', $data);
    }
    ...
    public function delete_user($data)
    {
        ...
        $this->db->update('sso.ref_user', array('active' => '2'));
        return $data['id_user'];
    }

...
<body class="sidebar-mini wysihtml5-supported <?= $this->config->item('color') ?>">
	...
	<script type='text/javascript'>
		var buTable = $('#buTable').DataTable({
			...
			"serverSide": true,
			ajax: {
				url: "<?= base_url() ?>laporan/ax_data_laporan/",
				type: 'POST',
				data: function(d) {
					return $.extend({}, d, {
						"id_bu": $('#id_bu').val()
			...
			columns: [{
					...
					render: function(data, type, full, meta) {
						...
						str += '<li><a onclick="printRincian(' + data + ')"><i class="fa fa-copy"></i> Rincian</a></li>';
						str += '<li><a onclick="printPerbaikan(' + data + ')"><i class="fa fa-copy"></i> Perbaikan</a></li>';
						str += '<li><a onclick="printResume(' + data + ')"><i class="fa fa-file-o"></i> Resume</a></li>';
						str += '</ul>';
						str += '</div>';
						return str;
					}
		...
		function printRincian(id_permohonan) {
			var url = "<?= base_url() ?>laporan/print_rincian/";
			var id_bu = $("#id_bu").val();
		...
		function printPerbaikan(id_permohonan) {
			var url = "<?= base_url() ?>laporan/print_perbaikan/";
			var id_bu = $("#id_bu").val();
			var id_permohonan = id_permohonan;
		...
		function printResume(id_permohonan) {
			var url = "<?= base_url() ?>laporan/print_resume/";
			var id_bu = $("#id_bu").val();
			var id_permohonan = id_permohonan;
